...
/* Private defines -----------------------------------------------------------*/
#define TEST_IN2_Pin GPIO_PIN_13
#define TEST_IN2_GPIO_Port GPIOC
...
#define TEST_OUT2_GPIO_Port GPIOB
#define TEST_IN1_Pin GPIO_PIN_2
#define TEST_IN1_GPIO_Port GPIOB
#define WP__Pin GPIO_PIN_11
#define WP__GPIO_Port GPIOA
#define CAM_EN_Pin GPIO_PIN_8
#define CAM_EN_GPIO_Port GPIOB
